...
## migrate f1cecc4: [SKIP] use branch-25.08 of shared-workflows — 纯 CI workflow 分支引用更新

- **Upstream commit**: f1cecc4 (cugraph-gnn, James Lamb, 2025-05-27, PR #216)
- **跳过原因**: 仅修改 `.github/workflows/build.yaml`（1 个文件，4 处改动），将 `gha-artifacts/uploads` 分支引用替换为 `branch-25.08`（`conda-upload-packages.yaml`、`wheels-publish.yaml` × 3）。纯 CI shared-workflows 分支 pin 更新，Walpurgis 无 GitHub Actions CI 体系，无迁移价值。
