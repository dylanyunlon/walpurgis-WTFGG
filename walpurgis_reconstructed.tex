...
MAE~$2.93$, a $3.6\%$ improvement over its D2STGNN backbone ($3.04$).}
...
\midrule
\textbf{Walpurgis (ours)} & 2026 & \textbf{2.93} & \textbf{5.88} & \textbf{8.08} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Walpurgis (ours)}   & \textbf{2.63} & \textbf{2.95} & \textbf{3.18} & \textbf{3.38} \\
\bottomrule
\end{tabular}
\end{table}
...
D2 & Long-Horizon Degradation & Temporal & HDR (MAE/step) & 0.098 & \textbf{0.072} \\
