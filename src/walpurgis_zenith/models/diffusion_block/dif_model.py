"""
STLocalizedConv — Zenith变体
改写: gconv后增加skip connection, BN的eps提高稳定性
"""
import torch
...
class STLocalizedConv(nn.Module):
    def __init__(self, hidden_dim, pre_defined_graph=None,
        ...
        self.bn = nn.BatchNorm2d(self.hidden_dim, eps=1e-6)
    ...
    def forward(self, X, dynamic_graph, static_graph):
        ...
        batch_size, seq_len, num_nodes, kernel_size, num_feat \
            = X.shape
        support = []
