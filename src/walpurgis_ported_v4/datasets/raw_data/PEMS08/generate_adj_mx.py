"""
Walpurgis V4 — PEMS08 Adjacency Matrix Generator
Upstream: datasets/raw_data/PEMS08/generate_adj_mx.py
...
def build_adjacency(distance_df_filename, num_of_vertices, direction=True, id_filename=None):
    ...
    print(f"[V4-AdjMx] PEMS08 adjacency built:", file=sys.stderr)
...
if __name__ == "__main__":
    ...
    print("[V4] Saved adj_mx_08.pkl and adj_mx_08_distance.pkl", file=sys.stderr)
