"""Prism normalizer: symmetric normalization for better contrastive graph properties."""
import torch
import torch.nn as nn

from walpurgis_prism.utils.cal_adj import remove_nan_inf
