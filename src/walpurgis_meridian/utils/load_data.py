"""Meridian utils/load_data.py — data loading with scaler and adj processing."""
import pickle
import os
import numpy as np
from walpurgis_meridian.dataloader import DataLoader
from walpurgis_meridian.utils.cal_adj import *
