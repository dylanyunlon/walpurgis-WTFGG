"""Generate training/validation/test data splits for METR-LA dataset.

# ═══════════════════════════════════════════════════════════════════
# Walpurgis v4 Data Generator — METR-LA
# ═══════════════════════════════════════════════════════════════════
...
def generate_train_val_test(args):
    ...
    print(f"\n{'='*60}")
    print(f"[Walpurgis::METR-LA] Generating training data")
    ...
    print(f"\n[Walpurgis::METR-LA] COMPLETE in {elapsed:.3f}s")
