"""Common speed data generation (METR-LA, PEMS-BAY)."""
import os, sys, numpy as np
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..', '..'))

def generate_speed_data(data_path, output_dir, seq_x=12, seq_y=12):
    print(f"[ECL] Generate speed data: {data_path} -> {output_dir}")
