"""
Forecast (diffusion branch) — Umbra变体
保持AR预测结构, 适配Random Walk Restart扩散
"""
import torch
...
class Forecast(nn.Module):
    def __init__(self, hidden_dim, forecast_hidden_dim=None,
                 **model_args):
        super().__init__()
    ...
    def forward(self, gated_history_data, hidden_states_dif,
                localized_st_conv, dynamic_graph,
                static_graph):
        predict = []
