#!/bin/bash
# ============================================================
# Nightfall Training Pipeline (D2STGNN Nightfall variant)
# 从项目根目录运行: bash run_nightfall.sh
#
# 环境变量:
#   DATASET        数据集 (默认: SYNTH)
#   DEVICE         设备  (默认: cpu)
#   EPOCHS         轮数  (默认: 使用config值)
#   NIGHTFALL_DEBUG 调试  (默认: 0)
# ============================================================
set -e
...
echo "=========================================="
echo "   Nightfall (D2STGNN) Training Pipeline"
...
from walpurgis_nightfall.generate_synth_data import generate_synth_traffic
